...
class SearchFilterFormType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options) :void
    {
        ...
        $builder
            ...
            ->add('runtime', IntegerType::class, ['label' => 'country', 'description' => 'Return only stores with a products with minimum subscription time'])
            ->add('recurring', ChoiceType::class, ['label' => 'recurring', 'choices' => [0 => 0,1 => 1], 'choices_as_values' => true, 'required' => false, 'description' => 'Return only stores with recurring products'])
